...
if exists('thingsboard_gateway/config/gateway.json'):
    CONFIG_PATH = 'thingsboard_gateway/config/gateway.json'
elif exists(path.dirname(path.abspath(__file__)) + '/config/gateway.json'.replace('/', path.sep)):
    CONFIG_PATH = path.dirname(path.abspath(__file__)) + '/config/gateway.json'.replace('/', path.sep)
elif exists("/etc/thingsboard-gateway/config/gateway.json".replace('/', path.sep)):
    CONFIG_PATH = "/etc/thingsboard-gateway/config/gateway.json".replace('/', path.sep)
