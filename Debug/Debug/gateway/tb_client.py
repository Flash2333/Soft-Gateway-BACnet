...
try:
    from tb_mqtt_client.tb_gateway_mqtt import TBGatewayMqttClient, TBDeviceMqttClient, GATEWAY_ATTRIBUTES_RESPONSE_TOPIC, GATEWAY_ATTRIBUTES_TOPIC
except ImportError:
...
import tb_mqtt_client.tb_device_mqtt as tb_device_mqtt
...
class TBClient(threading.Thread):
    ...
    def is_connected(self):
        return self.__is_connected # and self.client.rate_limits_received comment by jackie kuang
    ...
    def _on_connect(self, client, userdata, flags, result_code, *extra_params):
        ...
        try:
            ...
            #else: Commented by jackie kuang
